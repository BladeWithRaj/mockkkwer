            ...
            <div style="background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 16px; padding: 20px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 10px;">
                ${this._availablePapers.map(p => {
                  ...
                  const branchColors = { Mechanical:'rgba(245,158,11,0.15)', Civil:'rgba(16,185,129,0.15)', CS:'rgba(99,102,241,0.15)', Electrical:'rgba(234,179,8,0.15)', Electronics:'rgba(236,72,153,0.15)' };
